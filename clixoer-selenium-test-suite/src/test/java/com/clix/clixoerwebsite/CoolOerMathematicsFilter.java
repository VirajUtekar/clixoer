...
public class CoolOerMathematicsFilter extends base {
	...
	@Test
	public void verifyTheMathematicsFilterOptionIsChecked() throws InterruptedException {
		...
		co.getMathematicsSubjectFilter().click();
		log.info("mathematics filter option is been checked");
		
		boolean optionEnabled = co.getMathematicsSubjectFilter().isEnabled();
		
		if(optionEnabled) {
			Assert.assertTrue(true);
			System.out.println("mathematics filter option under subject domain is been enabled");
		}
		else
		{
	...
	@Test
	public void verifyTheNumberOfResourcesForMathematicsFilter() {
		...
		System.out.println("number of resources for mathematics filter is:"+totalResources);
		log.info("number of resources for mathematics filter is:"+totalResources);	
	}
	
	@Test
	public void verifyTheNumberOfLinksForMathematicsFilter() {
		...
		System.out.println("number of links for mathematics filter is:"+numberOfLinks);
		
	}
	

	@Test
	public void verifyTheResoucesTitleForMathematicsFilter() {
		...
		System.out.println("resources title for mathematics filter is:"+value);
		log.info("resources title for mathematics filter is:"+value);
	}
