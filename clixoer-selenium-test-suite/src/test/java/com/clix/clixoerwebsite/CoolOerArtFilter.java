...
public class CoolOerArtFilter extends base {
	...
	public void verifyTheArtFilterOptionIsChecked() throws InterruptedException {
		...
		co.getArtMultipleSubjectsFilter().click();
		log.info("art filter option is been checked");
		
		boolean optionEnabled = co.getArtMultipleSubjectsFilter().isEnabled();
		
		if(optionEnabled) {
			Assert.assertTrue(true);
			System.out.println("art filter option under subject domain is been enabled");
		}
		else
		{
	...
	@Test
	public void verifyTheNumberOfResourcesForArtFilter() {
		...
		System.out.println("number of resources for art filter is:"+totalResources);
		log.info("number of resources for art filter is:"+totalResources);	
	}
	
	@Test
	public void verifyTheNumberOfLinksForArtFilter() {
		...
		System.out.println("number of links for art filter is:"+numberOfLinks);
	...
	public void verifyTheResoucesTitleForArtFilter() {
		...
		System.out.println("The resources list after art filter is:"+value);
		log.info("The resources list after art filter is:"+value);
	}
